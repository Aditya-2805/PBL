...
REM
REM Generated by Vivado on Sat Feb 21 15:09:49 +0530 2026
...
echo "xvlog --incr --relax -prj dmem_tb_vlog.prj"
call xvlog  --incr --relax -prj dmem_tb_vlog.prj -log xvlog.log
